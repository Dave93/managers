...
// Extend SelectPrimitive.Root props to include onClear callback
interface SelectClearableProps extends React.ComponentPropsWithoutRef<typeof SelectPrimitive.Root> {
    onClear?: () => void;
}
...
const SelectClearable = (
    {
        ...
        ref: React.RefObject<React.ElementRef<typeof SelectPrimitive.Root>>;
    }
) => {
...
// Extend trigger props to handle clear button
interface SelectTriggerProps extends React.ComponentPropsWithoutRef<typeof SelectPrimitive.Trigger> {
    onClear?: () => void;
    showClear?: boolean;
}

const SelectTriggerClearable = (
    {
        ref,
        className,
        children,
