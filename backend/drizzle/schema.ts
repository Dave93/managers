...
export const invoices = pgTable("invoices", {
  ...
  (table) => {
    return {
      incomingInvoice_pkey: primaryKey({ columns: [table.id, table.incomingDate], name: "incomingInvoice_pkey" })
    }
  });
...
export const invoice_items = pgTable("invoice_items", {
  ...
  (table) => {
    return {
      incomingInvoiceItems_pkey: primaryKey({ columns: [table.id, table.invoiceincomingdate], name: "incomingInvoiceItems_pkey" })
    }
  });