...
export const usersWorkSchedulesController = new Elysia({
  ...
  .get(
    ...
    {
      permission: "users_work_schedules.list",
      query: t.Object({
        limit: t.String(),
        offset: t.String(),
  ...
  .post(
    ...
    {
      permission: "users_work_schedules.add",
      body: t.Object({
        data: t.Object({
          user_id: t.String(),
  ...
  .post(
    "/users_work_schedules/assign_work_schedules",
    async ({ body: { data }, user, set, drizzle }) => {
      await drizzle
        .delete(users_work_schedules)
        .where(eq(users_work_schedules.user_id, data.user_id))
        .execute();

      const users_work_schedulesList = await drizzle
        .insert(users_work_schedules)
        .values(
          data.work_schedule_id.map((work_schedule_id: string) => ({
    ...
    {
      permission: "users_work_schedules.edit",
      body: t.Object({
        data: t.Object({
          user_id: t.String(),
